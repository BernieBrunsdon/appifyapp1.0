      ...
      <div className="relative">
        ...
        <section className="py-20 md:py-24 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
                Trusted by <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Leading Brands</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Join thousands of businesses worldwide who trust Appify.AI to automate their operations and grow their revenue.
              </p>
            </div>
            
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-gray-800/20 to-gray-700/20 border border-gray-600/30 p-8">
              <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-gray-800/20 to-transparent z-10"></div>
              <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-gray-800/20 to-transparent z-10"></div>
              
              <div className="flex animate-scroll space-x-8">
                <div className="flex space-x-8 flex-shrink-0">
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <img 
                    ...
                    />
                    <div className="hidden text-gray-600 font-semibold text-lg">Microsoft</div>
                  </div>
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <img 
                    ...
                    />
                    <div className="hidden text-gray-600 font-semibold text-lg">Google</div>
                  </div>
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <img 
                    ...
                    />
                    <div className="hidden text-gray-600 font-semibold text-lg">Amazon</div>
                  </div>
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <img 
                      src="/logos/salesforce-logo.svg" 
                      alt="Salesforce" 
                      className="max-h-12 w-auto object-contain"
                      onError={(e) => {
                        e.target.style.display = 'none';
                    ...
                    />
                    <div className="hidden text-gray-600 font-semibold text-lg">Salesforce</div>
                  </div>
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <img 
                      src="/logos/hubspot-logo.svg" 
                      alt="HubSpot" 
                      className="max-h-12 w-auto object-contain"
                      onError={(e) => {
                        e.target.style.display = 'none';
                    ...
                    />
                    <div className="hidden text-gray-600 font-semibold text-lg">HubSpot</div>
                  </div>
                </div>
                <div className="flex space-x-8 flex-shrink-0">
                  <div className="bg-white/90 p-6 rounded-xl border border-gray-200 flex items-center justify-center min-w-[200px] h-20 hover:shadow-lg transition-all duration-300 hover:scale-105">
              ...
              <div className="text-center md:text-left">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-center md:justify-start space-x-3">
                    ...
                    <a href="mailto:admin@appifyai.com" className="text-gray-300 hover:text-white transition">
                      admin@appifyai.com
                    </a>
                  </div>
                  <div className="flex items-center justify-center md:justify-start space-x-3">
